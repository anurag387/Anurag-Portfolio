                    ...
                    <div>
                      ...
                      <div className="space-y-4">
                        ...
                        <div>
                          ...
                          <div className="bg-[#1a1b1e] border border-white/5 rounded-xl px-3 py-2 text-xs text-gray-200 select-all">
                            {identity.education.degree} — {identity.education.institution}
                          </div>
                        </div>
                        <div>
                    ...
                    <div>
                      ...
                      <div className="grid grid-cols-2 gap-2">
                        <div className="bg-[#1a1b1e] border border-white/5 rounded-xl px-3 py-2">
                          <div className="font-mono text-[9px] text-zinc-500 uppercase tracking-wider">SSC / HSC</div>
                          <div className="text-xs text-zinc-200 mt-0.5 truncate font-medium">GPA 5.00</div>
                        </div>
                        <div className="bg-[#1a1b1e] border border-white/5 rounded-xl px-3 py-2">
                          <div className="font-mono text-[9px] text-zinc-500 uppercase tracking-wider">Certificates</div>
                          <div className="text-xs text-zinc-200 mt-0.5 font-medium">5 earned</div>
                        </div>
                      </div>
                    </div>
                ...
                <div className="grid sm:grid-cols-2 gap-3 text-left mb-6">
                  ...
                  >
                    ...
                    <div>
                      ...
                      <div className="text-xs text-zinc-200">{identity.githubUsername}</div>
                    </div>
                  </a>
                  ...
                  >
                    ...
                    <div>
                      ...
                      <div className="text-xs text-zinc-200">{identity.facebookUsername}</div>
                    </div>
                  </a>
                  ...
                  >
                    ...
                    <div>
                      ...
                      <div className="text-xs text-zinc-200">{identity.instagramUsername}</div>
                    </div>
                  </a>
                </div>
